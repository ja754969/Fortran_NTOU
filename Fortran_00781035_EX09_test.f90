! 曾鈺皓 00781035 Fortran_HW9_1 : test
IMPLICIT NONE
...
WRITE(50,'(A)') 'gmt begin doubleY_jpg jpg'
!WRITE(50,'(A)') 'gmt set GMT_THEME cookbook'
!WRITE(50,'(A)') 'gmt plot x_sinx_y1.dat -R0/10/-2/2 -Jx1i -B -Wthicker ^'
...
!WRITE(50,'(A)') 'gmt psxy FT_00781035_EX09_1.out -R -J -O -K'
!WRITE(50,'(A)') 'gmt plot x_sinx_y1.dat -R0/10/-2/2 -JX15c/7c -Bxa2+l"X-axis" -By+l"Y-axis" -B+t"Plot_double_Y" -Wthinner -BWNse'
!WRITE(50,'(A)') 'gmt plot FT_00781035_EX09_2.out -R0/11/15/25 -Bya2f20+l"Ta [^oC]" -BwSnE'
